...
from src.reconcile import load_players, reconcile_cell_with_position
...
def run_full_board():
    ...
    rectified_image = normalize_board("data/draftboard.png", "full_board_out")
    ...
    cells = cells_from_rectified(rectified_image, output_dir="full_board_out")
    ...
    emit_all_outputs(results, rectified_image, cells, "full_board_out")
    ...
    print(f"\nResults saved to: full_board_out/")
    print(f"Check the following files:")
    print(f"  - full_board_out/board.csv (complete data)")
    print(f"  - full_board_out/rows.txt (row-major format)")
    print(f"  - full_board_out/cols.txt (column-major format)")
    print(f"  - full_board_out/overlay.png (visual overlay)")
